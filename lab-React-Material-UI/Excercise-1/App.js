...
class App extends Component {
  ...
  state = {
    items: [
      { id: 1, currentItem: {name: 'Anders And', service: 'Salg', price: 150}, editMode: false, editItem: {} },
      { id: 2, currentItem: {name: 'Bestseller DK',  service: 'Retur',    price: 250}, editMode: false, editItem: {} },
      { id: 3, currentItem: {name: 'Brande', service: 'Salg',       price: 350}, editMode: false, editItem: {} }
    ],
    itemsLastId: 3,
